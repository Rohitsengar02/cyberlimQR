...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/media/sdb1/Proyectos/Next qrCode/next-app/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/media/sdb1/Proyectos/Next qrCode/next-app/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "mongodb+srv://frfantusatti:JB3bSf73mNJj55NP@cluster0.a80zauj.mongodb.net/appqr?retryWrites=true&w=majority&appName=Cluster0"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"mongodb\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel QRCode {\n  id        String   @id @default(auto()) @map(\"_id\") @db.ObjectId\n  userId    String // Relación con el usuario (si es multiusuario)\n  content   String // El texto o URL que representa el QR\n  label     String? // Nombre personalizado para identificarlo\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  // Opciones de personalización del QR\n  size    Int    @default(128) // Tamaño en píxeles\n  bgColor String @default(\"#ffffff\") // Color de fondo\n  fgColor String @default(\"#000000\") // Color del código QR\n  level   String @default(\"L\") // Nivel de corrección de errores: L, M, Q, H\n\n  // Puedes agregar más campos si usas logos, bordes, etc.\n}\n\nmodel User {\n  id            String          @id @default(auto()) @map(\"_id\") @db.ObjectId\n  name          String?\n  email         String?         @unique\n  emailVerified DateTime?\n  image         String?\n  accounts      Account[]\n  sessions      Session[]\n  // Optional for WebAuthn support\n  Authenticator Authenticator[]\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel Account {\n  id                String  @id @default(auto()) @map(\"_id\") @db.ObjectId\n  userId            String  @db.ObjectId\n  type              String\n  provider          String\n  providerAccountId String\n  refresh_token     String? @db.String\n  access_token      String? @db.String\n  expires_at        Int?\n  token_type        String?\n  scope             String?\n  id_token          String? @db.String\n  session_state     String?\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@unique([provider, providerAccountId])\n}\n\nmodel Session {\n  id           String   @id @default(auto()) @map(\"_id\") @db.ObjectId\n  sessionToken String   @unique\n  userId       String   @db.ObjectId\n  expires      DateTime\n  user         User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel VerificationToken {\n  id         String   @id @default(auto()) @map(\"_id\") @db.ObjectId\n  identifier String\n  token      String\n  expires    DateTime\n\n  @@unique([identifier, token])\n}\n\n// Optional for WebAuthn support\nmodel Authenticator {\n  credentialID         String  @id @map(\"_id\")\n  userId               String  @db.ObjectId\n  providerAccountId    String\n  credentialPublicKey  String\n  counter              Int\n  credentialDeviceType String\n  credentialBackedUp   Boolean\n  transports           String?\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@unique([userId, credentialID])\n}\n",
  "inlineSchemaHash": "7b7eb5c1b2bfac664bc6ac29763f7014963446207b1b5f4f95b4e17d603033d6",
  "copyEngine": true
}
